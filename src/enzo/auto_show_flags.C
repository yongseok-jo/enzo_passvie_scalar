...
void auto_show_flags(FILE *fp) {
   ...
   fprintf (fp,"CC  = /appl/mpich-3.3.1-intel/bin/mpicc\n");
   fprintf (fp,"CXX = /appl/mpich-3.3.1-intel/bin/mpicxx\n");
   fprintf (fp,"FC  = /appl/mpich-3.3.1-intel/bin/mpifort\n");
   fprintf (fp,"F90 = /appl/mpich-3.3.1-intel/bin/mpifort\n");
   fprintf (fp,"LD  = /appl/mpich-3.3.1-intel/bin/mpicxx\n");
   fprintf (fp,"\n");
   ...
   fprintf (fp,"\n");
   fprintf (fp,"INCLUDES = -I/home/kerex/private_packages/hdf5/include  -I/appl/mpich-3.3.1-intel/include           -I.\n");
   fprintf (fp,"\n");
   ...
   fprintf (fp,"\n");
   fprintf (fp,"LIBS     = -L/home/kerex/private_packages/hdf5/lib -lhdf5 -lz  -lifcore -lifport -limf -lstdc++    -L/appl/mpich-3.3.1-intel/lib -lmpi        \n");
   fprintf (fp,"\n");
}
