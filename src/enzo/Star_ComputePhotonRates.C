...
#define GMC_TEST_5 //#####  for 121512_dGF-RTF
    ...
    /* 1.18e34 erg/s/Msun for 40 Myrs matches 2e51 ergs of stellar feedback energy as in Ceverino & Klypin (2009)
       1.53e46/6.25e11 * (16-13.6) * (1-0.8) = 1.18e34 erg/s/Msun */
    Q[0] = 1.53e46 * (1 - StarMassEjectionFraction) * this->Mass; 
#endif /* GMC_TEST_5 */

#define GMC_TEST_6  //#####  for 080112_CHaRGe/1e13vb_aRTF, UV bin only for the real MBH, check your notes, 
#ifdef GMC_TEST_6 //#####
    if (this->BirthTime < 0) {
      float UVLuminosityFractionMBH;
      UVLuminosityFractionMBH = 0.1; // very fiducial, but based on Richards et al. (SDSS quasar specturm; 2006)  
      
      // 1.99e33 g/Ms * (3e10cm/s)^2 * 6.24e11eV/ergs = 1.12e66 eV/Ms 
      
      /* Assuming a Eddington-limited accretion of 0.02 (M/1e6Ms) Msun/yr, radiative efficiency of 5%, and UV fraction of 1%, 
	 the feedback energy becomes
	 1.12e66 eV/Ms * 1ergs/6.24e11eV * 0.05 * 0.01 * 0.02 Ms/yr * (M/1e6Ms) * 1yr/3.15e7s = 5.70e35 erg/s/Msun */
      Q[0] = 1.12e66 * MBHFeedbackRadiativeEfficiency * UVLuminosityFractionMBH *
	this->last_accretion_rate / E[0]; 

      if (MyProcessorNumber == ROOT_PROCESSOR) 
        fprintf(stdout, "star::ComputePhotonRates: for MBH, Q[0]=%g\n", Q[0]);   
    }
#endif /* GMC_TEST_6 */
