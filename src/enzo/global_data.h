...
#define GMC_TEST
#ifdef GMC_TEST
EXTERN float lev_start_time[100][100];
EXTERN FLOAT bh_pos[3];  // by Jo
EXTERN FLOAT leakage_sf_tmp;
EXTERN FLOAT leakage_sf;
EXTERN FLOAT leakage_bh;
EXTERN FLOAT leakage_bh_tmp;
#endif
