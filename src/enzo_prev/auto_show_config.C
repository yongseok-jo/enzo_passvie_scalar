...
void auto_show_config(FILE *fp) {
   fprintf (fp,"\n");
   fprintf (fp,"   MACHINE: NASA Pleiades\n");
   fprintf (fp,"   MACHINE-NAME: nasa-pleiades\n");
   fprintf (fp,"\n");
   ...
   fprintf (fp,"   CONFIG_OBJECT_MODE  [object-mode-{32,64}]                 : 64\n");
   ...
   fprintf (fp,"   CONFIG_CVODE  [cvode-{yes,no}]                            : no\n");
   ...
   fprintf (fp,"   CONFIG_TPVEL  [tpvel-{yes,no}]]                           : no\n");
   ...
   fprintf (fp,"   CONFIG_BITWISE_IDENTICALITY  [bitwise-{yes,no}]           : yes\n");
   fprintf (fp,"   CONFIG_FAST_SIB  [fastsib-{yes,no}]                       : yes\n");
   fprintf (fp,"   CONFIG_FLUX_FIX  [fluxfix-{yes,no}]                       : yes\n");
