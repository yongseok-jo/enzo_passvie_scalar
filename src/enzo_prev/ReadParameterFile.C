...
int ReadParameterFile(FILE *fptr, TopGridData &MetaData, float *Initialdt)
{
  ...
  */
  ...
  /* If using MBHFeedback = 2 to 6 (Star->FeedbackFlag = MBH_JETS), 
     you need MBHParticleIO for angular momentum */

  if (MBHFeedback >= 2 && MBHFeedback <= 6) 
    MBHParticleIO = TRUE;

  /* If using MBHFeedback = 6 (Star->FeedbackFlag = MBH_JETS with radio-/quasar-mode duality), 
     you should have radiative transfer turned on as well */
